...
{
    class PulseOfLife : FFRKInspector.GameData.SoulBreak
    {
        public override uint SoulBreakId { get { return 20120006; } }
        ...
        public override string Name { get { return "Pulse of Life"; } }
    }
}
